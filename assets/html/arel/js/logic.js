...
arel.sceneReady(function() {
    ...
    scenario.currentTrackingConfigPathOrIdentifier = "html/resources/TrackingConfig_b0064bd143b73f0570deb9c19392a71f.zip";
    ...
    var pattern4 = {};
    scenario.trackables.push(pattern4);
    pattern4.objectName = "pattern4";
    pattern4.cosName = "photo (9)_2";
    pattern4.cosID = "2";
    pattern4.isCurrentlyTracking = false;
    pattern4.currentTrackingValues = null;
    pattern4.onTracked = function (trackingValues) {
        arel.Debug.log(this.objectName + ".onTracked()");
        this.isCurrentlyTracking = true;
        this.currentTrackingValues = trackingValues;
        image7.display();
    ...
    pattern4.onTrackingLost = function (trackingValues) {
        arel.Debug.log(this.objectName + ".onTrackingLost()");
        this.isCurrentlyTracking = false;
        this.currentTrackingValues = null;
        image7.hide();
    ...
    // grains80
    if (!arel.Scene.objectExists("image7")) {
        arel.Debug.log("ERROR: retrieving the object image7, it seems that it does not exist. Maybe it would help cleaning the cache or a problem occurred while reloading the channel.");
    }
    ...
    image7.type = "Image";
    image7.scene = scene1;
    image7.associatedTrackable = pattern4;
    ...
    image7.play = function (animationName, animationLooped) {
        arel.Debug.log(this.objectName + ".play(" + animationName + ", " + animationLooped + ")");
        this.startAnimation(animationName, animationLooped);
        if (methodExists(this, this.onPlayed)) {
            this.onPlayed(animationName);
