...
public final class MainActivity extends Activity implements Renderer
{
	...
	private void createCards() {
	        ...
	        card = new Card(this);
	        card.setFootnote("Your plate today");
	        card.setImageLayout(Card.ImageLayout.FULL);
	        //card.addImage(R.drawable.fruits40); //uncomment later
	        mCards.add(card);
	        /*
	        card = new Card(this);
	        card.setFootnote("Now");
	        card.setImageLayout(Card.ImageLayout.FULL);
	        card.addImage(R.drawable.plate); //change
	        mCards.add(card);

	        card = new Card(this);
	        card.setText("Sample card");
	        card.setFootnote("sample footnote");
	        mCards.add(card);*/
	    }
	@Override
	...
	protected void onResume()
	{
		...
		mCardScroller.activate(); //tuesday
	}
	...
	protected void onDestroy()
	{
		...
		if (mSensors != null)
		{
		 ...
		 mCardScroller.deactivate(); //tuesday
	}
	...
	public void onDrawFrame(GL10 gl)
	{
		...
		{
			//tuesday - activtate the cards 
			Log.i("Grace", "is recognized"); //IS RECOGNIZED!!
			mCardScroller.activate(); //WHY DOESNT THIS WORK?! 
