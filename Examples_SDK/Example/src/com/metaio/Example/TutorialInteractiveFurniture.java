...
public class TutorialInteractiveFurniture extends ARViewActivity
{
	...
	protected void loadContents()
	{
		try
		{
			...
			File filepath =
					AssetsManager.getAssetPathAsFile(getApplicationContext(), "TutorialInteractiveFurniture/Assets/tv.obj");
			if (filepath != null)
			{
			...
			filepath =
					AssetsManager
							.getAssetPathAsFile(getApplicationContext(), "TutorialInteractiveFurniture/Assets/stuhl.obj");
			if (filepath != null)
			{
